...
do
  echo ">>>>>>> Test $COUNTER/$REPEATS: $TEST2-$COUNTER.log <<<<<<<<"
  bash RUN_TEST.sh $WTEST1 RUN_REPEATED_LAST.log
  mv $WTEST1.log $WTEST1-$COUNTER.log
done

for COUNTER in `seq 1 $REPEATS`;
do
  echo ">>>>>>> Test $COUNTER/$REPEATS: $TEST2-$COUNTER.log <<<<<<<<"
  bash RUN_TEST.sh $WTEST2 RUN_REPEATED_LAST.log
  mv $WTEST2.log $WTEST2-$COUNTER.log
done

for COUNTER in `seq 1 $REPEATS`;
do
  echo ">>>>>>> Test $COUNTER/$REPEATS: $TEST2-$COUNTER.log <<<<<<<<"
  bash RUN_TEST.sh $WTEST3 RUN_REPEATED_LAST.log
  mv $WTEST3.log $WTEST3-$COUNTER.log
done

for COUNTER in `seq 1 $REPEATS`;
do
  echo ">>>>>>> Test $COUNTER/$REPEATS: $TEST2-$COUNTER.log <<<<<<<<"
  bash RUN_TEST.sh $WTEST4 RUN_REPEATED_LAST.log
  mv $WTEST4.log $WTEST4-$COUNTER.log
done
...
do
  echo ">>>>>>> Test $COUNTER/$REPEATS: $TEST2-$COUNTER.log <<<<<<<<"
  bash RUN_TEST.sh $WTEST5 RUN_REPEATED_LAST.log
  mv $WTEST5.log $WTEST5-$COUNTER.log
done

for COUNTER in `seq 1 $REPEATS`;
do
  echo ">>>>>>> Test $COUNTER/$REPEATS: $TEST2-$COUNTER.log <<<<<<<<"
  bash RUN_TEST.sh $WTEST6 RUN_REPEATED_LAST.log
  mv $WTEST6.log $WTEST6-$COUNTER.log
done

for COUNTER in `seq 1 $REPEATS`;
do
  echo ">>>>>>> Test $COUNTER/$REPEATS: $TEST2-$COUNTER.log <<<<<<<<"
  bash RUN_TEST.sh $WW RUN_REPEATED_LAST.log
  mv $WW.log $WW-$COUNTER.log
done
